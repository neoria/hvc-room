...
参考：https://did2memo.net/2016/11/26/a-parser-blocking-cross-origin-script-is-invoked-via-document-write/
  ...
  `);
  let hoge = document.createElement("script");
  // hoge.textContent = "alert(123)";
  hoge.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/jquery/3.4.1/jquery.min.js");
  document.body.appendChild(hoge);
  hoge = document.createElement("script");
  hoge.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.4/umd/popper.min.js");
  document.body.appendChild(hoge);
  hoge = document.createElement("script");
  hoge.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.3.1/js/bootstrap.min.js");
  document.body.appendChild(hoge);
  hoge = document.createElement("script");
  hoge.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/mdbootstrap/4.8.11/js/mdb.min.js");
  document.body.appendChild(hoge);
